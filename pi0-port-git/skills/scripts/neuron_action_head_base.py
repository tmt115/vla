...
class NeuronDenoisingWrapper(ModelWrapper):
    ...
    def get(self, bucket_rank: int = 0, **kwargs):
        ...
        the (callable, input_output_aliases) pair for tracing. Newer NxDI versions
        removed this from ModelWrapper and now expect a BaseModelInstance interface.
        This default implementation returns (self, {}) — self is the callable module.
        """
        return self, {}
